...
export const useGetNotificationsStore = create<NotificationState>(
  (set, get) => ({
    // --- INITIAL STATE ---
    ...
    getNotifications: async (page = 1, limit = 20) => {
      ...
      try {
        ...
        console.log(
          '🔔 [API Response] GET /notifications/get-user-all-notifications:',
          {
            url: `${API_BASEURL}/notifications/get-user-all-notifications`,
    ...
    getUnreadCount: async () => {
      ...
      try {
        ...
        const headers = { 'x-auth-token': token };
        const response = await axios.get(
          `${API_BASEURL}/notifications/get-unread-count`,
          { headers },
        );

        console.log('🔔 [API Response] GET /notifications/get-unread-count:', {
          url: `${API_BASEURL}/notifications/get-unread-count`,
          status: response.status,
          data: response.data,
        });
    ...
    markNotificationAsRead: async (notificationId: string) => {
      ...
      try {
        ...
        const headers = { 'x-auth-token': token };
        await axios.put(
          `${API_BASEURL}/notifications/mark-notification-as-read/${notificationId}`,
          {},
          { headers },
        );
        return true;
    ...
    markAllNotificationsAsRead: async () => {
      ...
      try {
        ...
        const headers = { 'x-auth-token': token };
        await axios.put(
          `${API_BASEURL}/notifications/mark-all-notifications-as-read`,
          {},
          { headers },
        );
        return true;
    ...
    deleteNotification: async (notificationId: string) => {
      ...
      try {
        ...
        const headers = { 'x-auth-token': token };
        await axios.delete(
          `${API_BASEURL}/notifications/delete-notification/${notificationId}`,
          { headers },
        );
        get().getUnreadCount();
        return true;
    ...
    getWisdomCardNotification: async () => {
      ...
      try {
        ...
        const headers = { 'x-auth-token': token };
        const response = await axios.get(
          `${API_BASEURL}/notifications/get-todays-wisdom-card`,
          { headers },
        );
        if (response.data?.success) {
          const data = response.data.data as WisdomCardDetailData;
    ...
    getRitualTipNotification: async () => {
      ...
      try {
        ...
        const headers = { 'x-auth-token': token };
        const response = await axios.get(
          `${API_BASEURL}/notifications/get-todays-ritual-tip`,
          { headers },
        );
        if (response.data?.success) {
          const data = response.data.data as RitualTipDetailData;
    ...
    updateNotificationSettings: async (
      ...
      try {
        ...
        console.log(
          '⚙️ [API Response] PUT /user/change-notifications-settings:',
          {
            url: `${API_BASEURL}/user/change-notifications-settings`,
            status: response.status,
