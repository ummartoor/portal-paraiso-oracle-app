...
// --- Zodiac Function (Remains the same) ---
...
const DateofBirthScreen_3 = () => {
  // --- MODIFIED: Select only colors directly ---
  ...
  const handleNext = async () => {
    if (!(date instanceof Date) || isNaN(date.getTime())) {
        console.error("Invalid date selected, cannot proceed.");
        return; 
    }
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.pickerTriggerContainer}>
          <TouchableOpacity
            ...
            onPress={showDatePicker} // Show the modal on press
          >
        ...
        {/* Footer with Next Button - Use simple string */}
