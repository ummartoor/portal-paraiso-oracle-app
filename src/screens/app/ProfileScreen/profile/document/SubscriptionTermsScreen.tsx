...
// --- ADDED: Helper component for bullet points ---
...
// --- ADDED: Helper component for bullet points with styled text ---
  ...
  return (
    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        {/* --- Scrollable Content (All text replaced with t() and Trans) --- */}
        <ScrollView
          style={styles.scrollView}
          contentContainerStyle={styles.scrollInner}
          showsVerticalScrollIndicator={false}
        >
          <Text style={[styles.lastUpdated, { color: colors.white }]}>{t('terms_last_updated')}</Text>

          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_intro_1')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_intro_2')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_intro_3')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s1_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s1_intro')}</Text>
          <BulletItemTrans textKey="terms_s1_li1" colors={colors} boldStyle={styles.bold} />
          <BulletItemTrans textKey="terms_s1_li2" colors={colors} boldStyle={styles.bold} />
          <BulletItemTrans textKey="terms_s1_li3" colors={colors} boldStyle={styles.bold} />
          <BulletItemTrans textKey="terms_s1_li4" colors={colors} boldStyle={styles.bold} />
          <Text style={[styles.paragraph, { color: colors.white, marginTop: 10 }]}>{t('terms_s1_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s2_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s2_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s3_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s3_intro')}</Text>
          <BulletItem textKey="terms_s3_li1" colors={colors} />
          <BulletItem textKey="terms_s3_li2" colors={colors} />
          <Text style={[styles.paragraph, { color: colors.white, marginTop: 10 }]}>{t('terms_s3_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s4_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s4_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s5_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s5_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s6_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s6_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s7_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s7_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s8_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s8_intro')}</Text>
          <BulletItem textKey="terms_s8_li1" colors={colors} />
          <BulletItem textKey="terms_s8_li2" colors={colors} />
          <BulletItem textKey="terms_s8_li3" colors={colors} />
          <Text style={[styles.paragraph, { color: colors.white, marginTop: 10 }]}>{t('terms_s8_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s9_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s9_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s10_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s10_p1')}</Text>

          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s11_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>{t('terms_s11_p1')}</Text>

          {/* --- ADDED: Contact section with email link --- */}
          <Text style={[styles.heading, { color: colors.primary }]}>{t('terms_s12_title')}</Text>
          <Text style={[styles.paragraph, { color: colors.white }]}>
            <Trans i18nKey="terms_s12_p1">
...
const styles = StyleSheet.create({
  ...
  paragraph: {
    ...
    marginBottom: 10,
    textAlign: 'left',
    flex: 1, // Important for Trans component
  },
  heading: {
    fontFamily: Fonts.cormorantSCBold,
    fontSize: 18,
