...
//   // =================================================================
//   // --- CHANGE 1: `debugVerifyPayment` ko store se add karein ---
//   // =================================================================
//   const {
//     packages,
//     isLoading,
...
//     currentSubscription,
//     fetchCurrentSubscription,
//     debugVerifyPayment, // <-- YAHAN ADD KIYA GAYA
//   } = useStripeStore(
//     useShallow(state => ({
//       packages: state.packages,
//       isLoading: state.isLoading,
...
//       currentSubscription: state.currentSubscription,
//       fetchCurrentSubscription: state.fetchCurrentSubscription,
//       debugVerifyPayment: state.debugVerifyPayment, // <-- YAHAN ADD KIYA GAYA
//     })),
//   );
...
//         } else {
//           // =================================================================
//           // --- CHANGE 2: `confirmPayment` fail hone par Debug Alert ---
//           // =================================================================
//           Alert.alert(
//             'Payment Verification Failed',
...
//                 onPress: () => {
//                   // Debug API ko paymentIntentId ke saath call karein
