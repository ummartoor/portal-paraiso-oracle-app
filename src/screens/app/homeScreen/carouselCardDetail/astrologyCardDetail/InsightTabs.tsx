...
const InsightTabs: React.FC<InsightTabsProps> = ({ horoscopeData, style }) => {
  ...
  const tabs: InsightTab[] = useMemo(() => {
    ...
    return DEFAULT_TABS.map(tab => {
      switch (tab.key) {
        case 'morning':
          return { ...tab, description: horoscopeData.data.morning_vibe };
        case 'career':
          return { ...tab, description: horoscopeData.data.career_and_work };
        case 'love':
          return {
            ...tab,
            description: horoscopeData.data.love_and_relationship,
          };
        case 'money':
          return { ...tab, description: horoscopeData.data.money_and_finance };
        case 'health':
          return {
            ...tab,
            description: horoscopeData.data.health_and_wellbeing,
          };
        case 'divine':
          return { ...tab, description: horoscopeData.data.divine_guidance };
        default:
          return { ...tab, description: '' }; // Fallback
      }
    });
  }, [horoscopeData]);
